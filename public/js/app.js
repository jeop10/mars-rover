...
window.Vue = __webpack_require__(/*! vue/dist/vue.common.dev */ "./node_modules/vue/dist/vue.common.dev.js");
var app = new Vue({
  el: '#roverApp',
  data: {
    startPointX: '',
  ...
  methods: {
    checkForInitialCoordinates: function checkForInitialCoordinates() {
      var vm = this;
      axios.get('/api/initial-coordinates').then(function (response) {
    ...
    checkForMovements: function checkForMovements() {
      var vm = this;
      axios.get('/api/previous-movements').then(function (response) {
        var data = response.data;
    ...
    saveStartingPoint: function saveStartingPoint() {
      var vm = this;
    ...
    clearNavigation: function clearNavigation() {
      var vm = this;
      axios.post('/api/clear-navigation', {}).then(function (response) {
        var data = response.data;
    ...
    checkCommand: function checkCommand() {
